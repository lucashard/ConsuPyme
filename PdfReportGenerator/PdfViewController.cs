...
namespace ReportManagement
{
    ...
    public class PdfViewController : Controller
    {
        ...
        protected ActionResult ViewPdf(string pageTitle, string viewName, object model,string dolares)
        {
          // Render the view html to a string.
            string htmlText = this.htmlViewRenderer.RenderViewToString(this, viewName, model,dolares);
